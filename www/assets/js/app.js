document.addEventListener("DOMContentLoaded", function() {
  const sidePanel = document.getElementById("sidePanel"), settingsBtn = document.getElementById("settings-btn"), mainChat = document.getElementById("main-box"), textForm = document.getElementById("text-form"), textEle = document.getElementById("text-msg"), loading = document.getElementById("loading-icon"), resp = document.getElementById("resp");
